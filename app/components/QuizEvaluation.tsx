...
export const RESULT_TEXTS: Record<ProductSet, string> = {
  ...
  'Kuperóza': 'Vypadá to, že vás trápí kuperóza! Nejlepší variantou pro vás bude zklidňující sada speciálně sestavená pro vaši pleť. Součástí balíčku je navíc manuál, ve kterém se dozvíte několik užitečných rad a tipů, které vaší pleti prospějí.',
