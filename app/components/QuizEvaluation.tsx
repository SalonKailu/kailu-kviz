...
export const RESULT_TEXTS: Record<ProductSet, string> = {
  ...
  'Normální základ': 'Pokud jste těhotná, tuto sadu vám doporučuji pro její šetrné složení a nízkou cenu. Pokud těhotná nejste, znamená tento výsledek to, že je vaše pleť naprosto normální! Gratuluji - a tiše vám závidím. 😊 Máte poměrně vzácný typ pleti, o kterém většina z nás může jen snít. Aby si vaše pleť zachovala svou přirozenou rovnováhu a vitalitu, připravila jsem pro vás základní kosmetickou sadu. S pravidelným používáním bude vaše pleť svěží, zdravá a přirozeně zářivá.',
